...
//public class BottomTabbarCustomed {
//}
/*
...
public class CostumedMenuView extends ViewGroup implements MenuView {
    ...
    public CostumedMenuView(Context context) {
        this(context, null);
    }

    public CostumedMenuView(Context context, AttributeSet attrs) {
        super(context, attrs);
